...
namespace VNPAY_CS_ASPX
{
    public partial class _Default : System.Web.UI.Page
    {
        ...
        protected void btnPay_Click(object sender, EventArgs e)
        {
            ...
            double Tongtien = Convert.ToDouble(lstCart.Sum(t => t.Price * t.quantity));
            ...
            order.OrderId = ddh.Id; // Giả lập mã giao dịch hệ thống merchant gửi sang VNPAY
            order.Amount = Convert.ToInt64(Tongtien); ; // Giả lập số tiền thanh toán hệ thống merchant gửi sang VNPAY 100,000 VND
