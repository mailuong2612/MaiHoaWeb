...
<%@ Import Namespace="MaiHoaWeb.Models" %>
<%@ Import Namespace="System.Web.Mvc.Html" %>
<%
    tb_Customer kh = (tb_Customer)Session["Taikhoan"];
    string Name = kh.CustomerName;
%> 
<%
    List<Cart> lstCart = (List<Cart>)Session["lstCart"];
    int Tongtien = Convert.ToInt32(lstCart.Sum(x => x.quantity * (x.Price)));
    int TongSoLuong = lstCart.Sum(x => x.quantity);
%>
        ...
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <ul class="list-group mb-3">
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    ...
                    <small class="text-muted"><%= TongSoLuong %></small>
                </li>
